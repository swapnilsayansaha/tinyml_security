...
class FastGRNNCellKeras(RNNCell):
    ...
    def __init__(self, hidden_size=50, gate_non_linearity="sigmoid",
...
class FastRNNCellKeras(RNNCell):
    ...
    def __init__(self, hidden_size=32, update_non_linearity="tanh",
...
class FastGRNNCell(RNNCell):
    ...
    def __init__(self, hidden_size=None, gate_non_linearity="sigmoid",
                 update_non_linearity="tanh", wRank=None, uRank=None,
...
class FastRNNCell(RNNCell):
    ...
    def __init__(self, hidden_size=None, update_non_linearity="tanh",
                 wRank=None, uRank=None, alphaInit=-3.0, betaInit=3.0,
