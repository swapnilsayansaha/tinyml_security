...
def parse_command():
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default=os.path.join(os.getenv('HOME')+'/209as_sec/audio_ks/', 'data'),
      help="""\
  ...
  parser.add_argument(
      '--bin_file_path',
      type=str,
      default=os.path.join(os.getenv('HOME')+'/tiny-master/v0.5/training/keyword_spotting/', 'kws_test_files'),
      help="""\
